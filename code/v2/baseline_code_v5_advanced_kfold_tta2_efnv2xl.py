...
# model config
model_name = 'tf_efficientnetv2_xl'  # 더 좋은 모델 사용
...
pred_df.to_csv(f"{output_path}/pred_advanced_kfold_tta2_efnv2xl.csv", index=False)

log.info(f"\n✅ Ensemble prediction completed and saved to {output_path}/pred_advanced_kfold_tta2_efnv2xl.csv")
