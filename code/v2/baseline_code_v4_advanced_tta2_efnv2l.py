...
# model_name = 'efficientnetv2_xl'  # EfficientNet v2 Large 모델 사용
# training config
...
pred_df.to_csv(f"{output_path}/pred_advanced_tta2_efnv2l.csv", index=False)

log.info(f"\n✅ Prediction completed and saved to {output_path}/pred_advanced_tta2_efnv2l.csv")
