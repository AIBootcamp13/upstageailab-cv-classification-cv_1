...
# # 증강 강도 비교
uv run main.py --config-name=wandb_aug wandb.run_name=intensity_0.5 augment.intensity=0.5 train.epochs=5 wandb.enabled=false device=mps
uv run main.py --config-name=wandb_aug wandb.run_name=intensity_1.0 augment.intensity=1.0 train.epochs=5 wandb.enabled=false device=mps
uv run main.py --config-name=wandb_aug wandb.run_name=intensity_2.0 augment.intensity=2.0 train.epochs=5 wandb.enabled=false device=mps
uv run main.py --config-name=wandb_aug wandb.run_name=intensity_5.0 augment.intensity=5.0 train.epochs=5 wandb.enabled=false device=mps
